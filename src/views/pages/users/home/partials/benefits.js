        ...
        <div class="row">
          <div class="col col-lg-4">
            <div class="policy_item">
              ...
              <div class="item_content">
                <h3 class="item_title">Bâtir une carrière</h3>
                <p class="mb-0">Tout ce qu'il faut pour décrocher un emploi</p>
              </div>
            </div>
          </div>
          ...
          <div class="col col-lg-4">
            <div class="policy_item">
              ...
              <div class="item_content">
                <h3 class="item_title">Se cultiver</h3>
                <p class="mb-0">Apprendre d'autres cultures</p>
              </div>
            </div>
          </div>
          ...
          <div class="col col-lg-4">
            <div class="policy_item">
              ...
              <div class="item_content">
                <h3 class="item_title">Obtenir des compétences</h3>
                <p class="mb-0">concentrez-vous sur vos besoins</p>
              </div>
            </div>
          </div>
        </div>
